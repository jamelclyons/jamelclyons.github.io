...
export var getProject = createAsyncThunk('project/getProject', function (repo) { return __awaiter(void 0, void 0, void 0, function () {
    var docRef, docSnap, project, error_1, err;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                docRef = doc(portfolioCollection, repo.id);
            ...
            case 1:
                ...
                return [2 /*return*/, project.toObject()];
            case 2:
                error_1 = _a.sent();
                err = error_1;
                console.error(err);
...
export var projectSlice = createSlice({
    ...
    extraReducers: function (builder) {
        builder
            ...
            .addCase(getProject.rejected, function (state, action) {
            state.projectLoading = false;
            state.projectError = action.error || null;
