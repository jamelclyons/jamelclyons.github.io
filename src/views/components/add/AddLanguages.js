...
var AddLanguages = function () {
    ...
    var languagesObject = useSelector(function (state) { return state.taxonomies; }).languagesObject;
    ...
    var handleAddLanguage = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var language, err;
        return __generator(this, function (_a) {
            e.preventDefault();
            try {
                language = new Taxonomy({
                    id: id,
                    type: 'languages',
                    title: title,
                    icon_url: icon_url,
    ...
    return (_jsx(_Fragment, { children: _jsxs("main", { children: [_jsx("h2", { children: "Add Languages" }), _jsxs("form", { action: "", children: [_jsx("input", { type: "text", name: "id", placeholder: "ID", value: id, onChange: handleChange }), _jsx("input", { type: "text", name: "title", placeholder: "Title", value: title, onChange: handleChange }), _jsx("input", { type: "text", name: "icon_url", placeholder: "icon_url", value: icon_url, onChange: handleChange }), _jsx("button", { onClick: handleAddLanguage, children: _jsx("h3", { children: "add" }) })] }), _jsx(StatusBarComponent, {})] }) }));
};
