...
var AddTechnologies = function () {
    ...
    var technologiesObject = useSelector(function (state) { return state.taxonomies; }).technologiesObject;
    ...
    var handleAddTechnology = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var err;
    ...
    return (_jsx(_Fragment, { children: _jsxs("main", { children: [_jsx("h2", { children: "Add Technology" }), _jsxs("form", { action: "", children: [_jsx("input", { type: "text", name: "id", placeholder: "ID", value: id, onChange: handleChange }), _jsx("input", { type: "text", name: "title", placeholder: "Title", value: title, onChange: handleChange }), _jsx("input", { type: "text", name: "icon_url", placeholder: "icon_url", value: icon_url, onChange: handleChange }), _jsx("button", { onClick: handleAddTechnology, children: _jsx("h3", { children: "add" }) })] }), _jsx(StatusBarComponent, {})] }) }));
};
