...
var UpdateDelivery = function (_a) {
    var projectID = _a.projectID, delivery = _a.delivery;
    ...
    var _c = __read(useState(delivery.gallery), 2), gallery = _c[0], setGallery = _c[1];
    var _d = __read(useState(delivery === null || delivery === void 0 ? void 0 : delivery.checkList), 2), checkList = _d[0], setCheckList = _d[1];
    // const [content, setContent] = useState(delivery?.checkList);
    var handleChangeGallery = function (e) {
        try {
            setGallery([]);
        }
        catch (error) {
    ...
    var handleChangeCheckList = function (e) {
        try {
            setCheckList([]);
        }
        catch (error) {
    ...
    var handleUpdateDelivery = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var form, formData, deliveryData_1, data, err;
        return __generator(this, function (_a) {
            ...
            try {
                ...
                formData.forEach(function (value, key) {
                    deliveryData_1[key] = value;
                });
                data = {
                    id: projectID,
                    delivery: deliveryData_1
                };
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h2", { className: "title", children: "delivery" }), _jsx("form", { action: "", id: 'update_delivery', children: _jsx("button", { onClick: handleUpdateDelivery, children: _jsx("h3", { children: "update" }) }) })] }));
};
